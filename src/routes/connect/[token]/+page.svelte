<script lang="ts">
  ...
  const buttonClass = "h-10 rounded bg-primary-300 px-4 py-2 font-bold text-stone-950 disabled:opacity-50";
...
<main class="grid min-h-[calc(100vh-64px)] place-items-center px-4 py-10">
  <section class={`${panelClass} grid w-full max-w-sm gap-4`}>
    <div>
      <p class="text-xs font-extrabold uppercase tracking-widest text-primary-300">Temporary access</p>
